        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContributorName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemContributors", x => new { x.ItemId, x.ContributorId });
                    table.ForeignKey(
                        name: "FK_ItemContributors_Contributors_ContributorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contributors_ContributorName",
                table: "Contributors",
                column: "ContributorName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ItemContributors_ContributorId",
                table: "ItemContributors",
                column: "ContributorId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemContributors_ItemId_ContributorId",
                table: "ItemContributors",
                columns: new[] { "ItemId", "ContributorId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_ItemName_CategoryId_TenantId",
                table: "Items",
